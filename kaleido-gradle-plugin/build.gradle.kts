...
dependencies {
    ...
    compileOnly("com.android.tools.build:aapt2-proto:9.2.1-15009934")
    ...
    testImplementation("com.android.tools.build:aapt2-proto:9.2.1-15009934")
